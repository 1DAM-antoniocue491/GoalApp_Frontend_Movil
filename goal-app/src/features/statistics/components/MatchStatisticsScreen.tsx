 ...
 *
 * Pantalla de estadísticas de un partido/equipo.
 * Muestra: equipo, goles, victorias/derrotas/empates y tabla de goleadores.
...
export function MatchStatisticsScreen() {
  return (
