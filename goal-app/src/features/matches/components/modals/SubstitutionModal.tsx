...
interface SubstitutionModalProps { visible: boolean; match: LiveMatchContext | null; onConfirm: (data: SubstitutionEventData) => void; onCancel: () => void; }
