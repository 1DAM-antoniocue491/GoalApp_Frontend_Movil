...
interface YellowCardModalProps { visible: boolean; match: LiveMatchContext | null; submitting?: boolean; onConfirm: (data: YellowCardEventData) => void; onCancel: () => void; }
function YellowCardModalComponent({ visible, match, submitting = false, onConfirm, onCancel }: YellowCardModalProps) {
