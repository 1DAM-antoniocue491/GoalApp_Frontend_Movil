...
interface SubstitutionModalProps { visible: boolean; match: LiveMatchContext | null; onConfirm: (data: SubstitutionEventData) => void; onCancel: () => void; submitting?: boolean; }
function SubstitutionModalComponent({ visible, match, onConfirm, onCancel, submitting = false }: SubstitutionModalProps) {
